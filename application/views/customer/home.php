...
<!-- //for-mobile-apps -->
<link href="<?php echo base_url('assets/assets_customer/') ?>css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?php echo base_url('assets/assets_customer/') ?>css/font-awesome.css" rel="stylesheet"> 
<link rel="stylesheet" href="<?php echo base_url('assets/assets_customer/') ?>css/chocolat.css" type="text/css" media="screen">
<link href="<?php echo base_url('assets/assets_customer/') ?>css/easy-responsive-tabs.css" rel='stylesheet' type='text/css'/>
<link rel="stylesheet" href="<?php echo base_url('assets/assets_customer/') ?>css/flexslider.css" type="text/css" media="screen" property="" />
<link rel="stylesheet" href="<?php echo base_url('assets/assets_customer/') ?>css/jquery-ui.css" />
<link href="<?php echo base_url('assets/assets_customer/') ?>css/style.css" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="<?php echo base_url('assets/assets_customer/') ?>js/modernizr-2.6.2.min.js"></script>
<!--fonts-->
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="<?php echo base_url('index.php/customer/home') ?>">SUN <span>RISE</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<img src="<?php echo base_url('assets/assets_customer/') ?>images/1.jpg" alt=" " class="img-responsive">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <img src="<?php echo base_url('assets/assets_customer/') ?>images/about.jpg" class="img-responsive" alt="Hair Salon">
										<div class="w3l-slider-img">
											<img src="<?php echo base_url('assets/assets_customer/') ?>images/a1.jpg" class="img-responsive" alt="Hair Salon">
										</div>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="<?php echo base_url('assets/assets_customer/') ?>images/teams3.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="<?php echo base_url('assets/assets_customer/') ?>images/teams4.jpg" alt=" " class="img-responsive" />
					</li>
					</ul>
					...
					<ul class="slides">
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="<?php echo base_url('assets/assets_customer/') ?>images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="<?php echo base_url('assets/assets_customer/') ?>images/c1.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="<?php echo base_url('assets/assets_customer/') ?>images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="<?php echo base_url('assets/assets_customer/') ?>images/c2.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="<?php echo base_url('assets/assets_customer/') ?>images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="<?php echo base_url('assets/assets_customer/') ?>images/c3.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="<?php echo base_url('assets/assets_customer/') ?>images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="<?php echo base_url('assets/assets_customer/') ?>images/c4.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
...
<!--/footer -->
<!-- js -->
<script type="text/javascript" src="<?php echo base_url('assets/assets_customer/') ?>js/jquery-2.1.4.min.js"></script>
<!-- contact form -->
<script src="<?php echo base_url('assets/assets_customer/') ?>js/jqBootstrapValidation.js"></script>

<!-- /contact form -->	
<!-- Calendar -->
		<script src="<?php echo base_url('assets/assets_customer/') ?>js/jquery-ui.js"></script>
		<script>
				$(function() {
...
<!-- //Calendar -->
<!-- gallery popup -->
<link rel="stylesheet" href="<?php echo base_url('assets/assets_customer/') ?>css/swipebox.css">
				<script src="<?php echo base_url('assets/assets_customer/') ?>js/jquery.swipebox.min.js"></script> 
...
<script type="text/javascript" src="<?php echo base_url('assets/assets_customer/') ?>js/move-top.js"></script>
<script type="text/javascript" src="<?php echo base_url('assets/assets_customer/') ?>js/easing.js"></script>
<script type="text/javascript">
...
<!-- start-smoth-scrolling -->
<!-- flexSlider -->
				<script defer src="<?php echo base_url('assets/assets_customer/') ?>js/jquery.flexslider.js"></script>
				<script type="text/javascript">
			...
			<!-- //flexSlider -->
<script src="<?php echo base_url('assets/assets_customer/') ?>js/responsiveslides.min.js"></script>
			<script>
...
<!--//search-bar-->
<!--tabs-->
<script src="<?php echo base_url('assets/assets_customer/') ?>js/easy-responsive-tabs.js"></script>
<script>
...
<!-- //smooth scrolling -->
<script type="text/javascript" src="<?php echo base_url('assets/assets_customer/') ?>js/bootstrap-3.1.1.min.js"></script>
</body>
</html>
