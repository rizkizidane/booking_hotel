...
@page { margin: 0; }
	...
	<body>
		<header>
			...
			<address >
				<p>SUN RISE HOTEL,</p>
				<p>Jl. Scientia Boulevard, Gading</p>
				<p>Kec. Serpong, Tangerang, Banten 15227</p>
			</address>
		</header>
		<article>
            <table class="meta">
                <tr>
                    ...
                    <td><?php echo $this->session->userdata('nama_customer')  ?></td>
                    <?php } else { ?>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>Rp. </span><span>
                    <?php 
