...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/assets_admin/') ?>css/style.css">
</head>
...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom">  <h3><a href="<?php echo base_url('index.php/dashboard.php') ?>">SUN RISE HOMEPAGE</a></h3></div>
